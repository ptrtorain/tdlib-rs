...
Current supported TDLib version: [1.8.38](https://github.com/tdlib/td/commit/d321984b75fccdb76239529e8aadcf7f80b0e35a).
...
`local-tdlib` require you to have the `tdlib` (version 1.8.38) compiled and installed on your system, and the following variables exported, for example in the `.bashrc` file:
...
remember to have the `tdlib` (version 1.8.38) compiled on your system, and the following variables exported, for example in the `.bashrc` file:
